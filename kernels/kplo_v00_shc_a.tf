...
Version and Date
--------------------------------------------------------
  Version kplo_v00.tf (Initial) -- August 3, 2022 --  Jo Ryeong Yim

      Added KPLO Name DANURI in the Name and Body Code (NAIF ID = -155).
      
      Modified LUTI, LUTIA, LUTIB Frame, STA after KPLO FM Final Alignment Test.
      - References
        [1] KPLO FM Alignment PTR_220426_r02.pdf by Dr. S.  Y. Min
        [2] KPLO-D1-510-023_F00_LUTI_LOS_measurement_signed.pdf by Dr. Yeon
        [3] KPLO-ADG-024 KPLO FM LUTI Alignment Result for FK by Jo Ryeong Yim
        
      - Description of LUTI Frame (-155100) changed and typo corrections: LUTIA --> LUTI  
      
      - LUTI: 
         (Was) Mspacecraft->luti = [0]X [0]Y [-45]Z 
         (Is)  Mspacecraft->luti = [0.472600704]X [-0.15990768]Y [-45.2134287]Z
 
         (was)  TKFRAME_-155100_ANGLES        = ( 45.0, 0.0, 0.0 )
         (is)   TKFRAME_-155100_ANGLES        = (45.2134287, 0.15990768,  -0.472600704 )
      
      - LUTIA and LUTIB
         (Was) LUTIA:  Mluti->lutiA = [0]Y [+1.35]X [0]Z
         (Was) LUTIB:  Mluti->lutiB = [0]Y [-1.35]X [0]Z 
         
         (Is)  LUTIA:  Mluti->lutiA = [0.15131801]Z [0.046873626]Y [1.3513916]X
         (Is)  LUTIB:  Mluti->lutiB = [-0.067598235]Z [-0.046832364]Y [-1.3513927]X
        
         (was)  TKFRAME_-155101_ANGLES        = (  0.0,  -1.35, 0.0 )
         (was)  TKFRAME_-155101_AXES          = (   3,    1,    2   )
         (was)  TKFRAME_-155102_ANGLES        = (  0.0, 1.35, 0.0 )
         (was)  TKFRAME_-155102_AXES          = (   3,    1,    2   )
         
         (is)   TKFRAME_-155101_ANGLES        = ( -1.3513916,  -0.046873626,  -0.15131801)
         (is)   TKFRAME_-155102_AXES          = (   1,    2,    3   )
         (is)   TKFRAME_-155102_ANGLES        = ( 1.3513927,  0.046832364,  0.067598235 )
         (is)   TKFRAME_-155102_AXES          = (   1,    2,    3   )

      - STA1: 
         (Was) Mspacecraft->sta1 = [-90]Z [+125]Y [+90]Z  
         (is)  Mspacecraft->sta1 = [-90.0226]Z [124.9757]Y [89.9182 ]Z  
         
         (was)  TKFRAME_-155501_ANGLES        = ( -90.0, -125.0, +90.0 ) 
         (is)   TKFRAME_-155501_ANGLES        = ( -89.9182, -124.9757, +90.0226 )
      
      - STA2: 
         (Was) Mspacecraft->sta2 = [+90]Z [+125]Y [0]Z  
         (Is) Mspacecraft->sta2 = [+90.06239]Z [+125.222148]Y [0.170028]Z  
         
         (was)  TKFRAME_-155502_ANGLES        = (  0.0, -125.0, -90.0 )
         (is)   TKFRAME_-155502_ANGLES        = ( -0.170028	-125.222148	-90.06239)
      
   
   Version 20210218 (draft) -- February 18, 2021 --  Jo Ryeong Yim

      Added KDSA01 Station ID (NAIF ID = 398032).
        
      Changed IAU_EARTH to ITRF93 in KPLO Frames Hierarchy.
...
--------------------------------------------------------
   ...
   These diagrams illustrate the spacecraft bus frame:
...
--------------------------------------------------------
   ...
   follows:
      ...
      *  +Z axis is along the LUTI (Center of LUTIA and LUTIB) boresight;
 
      *  +Y axis is parallel to the LUTIA and LUTIB CCD lines;
   ...
   by -45 degrees about Z from the spacecraft frame:
      ...
      Mspacecraft->luti = [0.472600704]X [-0.15990768]Y [-45.2134287]Z
   ...
   \begindata
      ...
      TKFRAME_-155100_ANGLES        = (45.2134287, 0.15990768,  -0.472600704 )
...
--------------------------------------------------------
   ...
   by +1.35 degrees about X from the LUTI frame:
      ...
      Mluti->lutiA = [0.15131801]Z [0.046873626]Y [1.3513916]X
   ...
   by -1.35 degrees about X from the LUTI frame:
      ...
      Mluti->lutiB = [-0.067598235]Z [-0.046832364 ]Y [-1.3513927 ]X
   ...
   \begindata
      ...
      TKFRAME_-155101_ANGLES        = ( -1.3513916,  -0.046873626,  -0.15131801)
      TKFRAME_-155102_AXES          = (   1,    2,    3   )
      TKFRAME_-155101_UNITS         = 'DEGREES'

      FRAME_KPLO_LUTI2              = -155102
      ...
      TKFRAME_-155102_ANGLES        = ( 1.3513927,  0.046832364,  0.067598235 )
      TKFRAME_-155102_AXES          = (   1,    2,    3   )
...
--------------------------------------------------------
   ...
   \begindata
      ...
      FRAME_KPLO_SHC_A              = -155151
      FRAME_-155151_NAME            = 'KPLO_SHC_A'
      FRAME_-155151_CLASS           = 4
      FRAME_-155151_CLASS_ID        = -155151
      FRAME_-155151_CENTER          = -155
      TKFRAME_-155151_SPEC          = 'ANGLES'
      TKFRAME_-155151_RELATIVE      = 'KPLO_SHC'
      TKFRAME_-155151_ANGLES        = ( 0.0, 0.0, 0.0 )
      TKFRAME_-155151_AXES          = (   3,   2,   1   )
      TKFRAME_-155151_UNITS         = 'DEGREES'
...
--------------------------------------------------------
   ...
   \begindata
      ...
      TKFRAME_-155501_ANGLES        = ( -89.9182, -124.9757, +90.0226 )
...
--------------------------------------------------------
   ...
   \begindata
      ...
      TKFRAME_-155502_ANGLES        = ( -0.170028	-125.222148	-90.06239)
...
--------------------------------------------------------
   ...
   \begindata
      ...
      NAIF_BODY_NAME += ( 'KDSA01' )
      NAIF_BODY_CODE += ( 398032 )
